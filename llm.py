...
print(f"可用 的目标模块: {TARGET_MODULES}")
...
with torch.no_grad():
    for i in range(len(test_dataset)):
        ...
        if final_category == "Unknown":
            ...
            keywords = {
                "PlayMusic": ["play", "music", "song", "album", "track", "hear", "listen", "on deezer", "on spotify", "on pandora", "on groove shark", "on last fm", "by artist", "singing", "playing"],
                "RateBook": ["rate", "rating", "stars", "out of", "points", "give", "star", "book", "novel", "textbook", "essay", "series", "chronicle"],
                "SearchCreativeWork": ["find", "search", "show", "locate", "see", "watch", "game", "painting", "photograph", "novel", "tv series", "trailer", "discography", "movie", "film", "picture", "journal"],
                "GetWeather": ["weather", "forecast", "temperature", "humid", "cloudy", "sunny", "rainy", "snowy", "freezing", "warm", "cold", "chillier", "hotter", "degrees", "humidity", "snowfall", "windy"],
                "BookRestaurant": ["book", "reservation", "table", "spot", "restaurant", "cafe", "bar", "gastropub", "reserve", "seating", "dinner", "lunch", "breakfast", "eat", "food", "cuisine"],
                "AddToPlaylist": ["add", "to my playlist", "include", "put", "incorporate", "playlist", "mix", "collection", "tracks", "songs"],
                "SearchScreeningEvent": ["movie", "theatre", "theater", "showing", "showtimes", "schedule", "time", "playing", "films", "cinema", "animated", "screening", "matinee", "showtime"]
            }
            matched = False
